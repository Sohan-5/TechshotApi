...
def extract_topn_keywords(id,summary):
    #FILE PATHS HERE
    tfidf_transformer=pickle.load(open("D:\\projects\\finalprj\\tfidf_transformer.pkl",'rb'))
    cv = pickle.load(open('D:\\projects\\finalprj\\cv.pkl','rb'))
